...
class UserAPI {
  ...
  async addFavDog(dogId) {
    // validate
    if (!dogId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/addFavDog"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem adding dog to favourites');
    } // convert response payload into json - store as data
...
class newDogView {
  ...
  async newDogSubmitHandler(e) {
    ...
    try {
      await _DogAPI.default.newDog(formData);

      _Toast.default.show("Dog Added!");
...
var _default = new newDogView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../DogAPI":"DogAPI.js","../../Toast":"Toast.js"}],"views/pages/favouriteDogs.js":[function(require,module,exports) {
"use strict";
...
class FavouriteDogsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Watch List\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\"> \n      <div class=\"dogs-grid\">\n        ", "\n        </div>      \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), this.favDogs == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        <div class=\"dog\"></div>\n        <h3 class=\"loading-message\">Loading...</h3>  \n        "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n          ", "\n        "])), this.favDogs.map(dog => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n            <va-dog class=\"dog-card\"\n            id=\"", "\"\n            name=\"", "\" \n            breed=\"", "\"\n            owner=\"", "\"\n            size=\"", "\"\n            age=\"", "\"\n            nature=\"", "\"\n            Energy=\"", "\"\n            image=\"", "\"\n            >        \n            </va-dog>\n          "])), dog._id, dog.name, dog.breed, JSON.stringify(dog.owner), dog.size, dog.age, dog.nature, dog.energy, dog.image))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
class MessageView {
  ...
  async getDog() {
    try {
      console.log(_DogAPI.default.currentDog);
      this.dog = await _DogAPI.default.getDog(_DogAPI.default.currentDog);
      this.render();
    } catch (err) {
      _Toast.default.show(err, 'error');
...
class MessagesView {
  ...
  async getMyMessages() {
    try {
      ...
      console.log(this.dogsList); // for buyer
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../MessageAPI":"MessageAPI.js","../../DogAPI":"DogAPI.js","../../Toast":"Toast.js","./message":"views/pages/message.js","./../../views/partials/splash":"views/partials/splash.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _dogs = _interopRequireDefault(require("./views/pages/dogs"));

var _newDog = _interopRequireDefault(require("./views/pages/newDog"));
...
customElements.define('va-dog', class Dog extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  async addFavHandler() {
    try {
      const currentUser = _Auth.default.currentUser;
      ...
      if (!favCheck) {
        await _UserAPI.default.addFavDog(this.id);

        _Toast.default.show('Dog added to favourites');
      } else {
        _Toast.default.show('Dog is already in favourites');
      }
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  ...
  render() {
    return (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    <style>\n        .owner {\n            font-size: 0.9em;\n            font-style: italic;\n            opacity: 0.9;\n        }\n        .image {\n            width: 50%;\n        }\n        img {\n            width: 100%;\n            height: 250px;\n        }\n        .card-size {\n          width: 100%;\n        }\n        sl-card {\n          --sl-color-white: none;\n          width: 100%;\n          color: #ffffff;\n          cursor: pointer;\n        }\n        .info-button {\n          height: 40px;\n          background-color: #ffffff;\n          width: 100px;\n          border: none;\n          border-radius: 4px;\n          box-shadow: 1px 2px 9px 0px #000000;\n          cursor: pointer;\n        }\n        .info-button:hover {\n          background-color: #C4C4C4;\n        }\n        .dog-heading {\n          margin: 0;\n        }\n        .dogs-grid {\n          display: flex;\n          flex-wrap: wrap;\n          > .dog-card {\n            width: calc(25% - 1em);\n            margin: 0.5em;\n          }\n        }\n    </style>  \n    <sl-card @click=", " class=\"card-size\">\n        <img class=\"listing-image\" slot=\"image\" src=\"", "/images/", "\" />\n        <h2 class=\"dog-heading\">", "</h2>\n        </sl-card>\n    "])), this.moreInfoHandler, _App.default.apiBase, this.image, this.name);
  }
...
customElements.define('va-my-dog', class Dog extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>\n        .owner {\n            font-size: 0.9em;\n            font-style: italic;\n            opacity: 0.9;\n        }\n        .image {\n            width: 50%;\n        }\n        img {\n            width: 100%;\n            height: 250px;\n        }\n        .card-size {\n          width: 100%;\n        }\n        sl-card {\n          --sl-color-white: none;\n          width: 100%;\n          color: #ffffff;\n        }\n        .info-button {\n          height: 40px;\n          background-color: #ffffff;\n          width: 100px;\n          border: none;\n          border-radius: 4px;\n          box-shadow: 1px 2px 9px 0px #000000;\n          cursor: pointer;\n        }\n        .info-button:hover {\n          background-color: #C4C4C4;\n        }\n        .dog-heading {\n          margin: 0;\n        }\n        .dogs-grid {\n          display: flex;\n          flex-wrap: wrap;\n          > .dog-card {\n            width: calc(25% - 1em);\n            margin: 0.5em;\n          }\n        }\n        .dog-tile-container {\n          display: flex;\n        }\n    </style>  \n    <sl-card @click=", " class=\"card-size\">\n        <img slot=\"image\" src=\"", "/images/", "\" />\n        <div class=\"dog-tile-container\">\n           <h2 class=\"dog-heading\">", "</h2>\n        </div>\n        </sl-card>\n    "])), this.setSelectedDog, _App.default.apiBase, this.image, this.name);
  }
